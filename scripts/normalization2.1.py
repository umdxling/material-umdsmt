...
# -*- coding: utf-8 -*- 
'''
Updated on August 7th, 2020, 3:07am
Version 2.1
...
if __name__ == '__main__':
    for line in sys.stdin:
        line = line.strip()
        text = process(language, line, letters_to_keep='', letters_to_remove='', lowercase=True, remove_repetitions_count=-1, remove_punct=True, remove_digits=True, remove_vowels=False, remove_diacritics=True, remove_spaces=False, remove_apostrophe=True, copy_through=True, keep_romanized_text=True)
        print(text)
